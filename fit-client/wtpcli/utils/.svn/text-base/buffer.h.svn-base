...
extern int buffer_get(struct buffer *b, char * buf, size_t bufsiz);
...
extern int buffer_printf(struct buffer *b, const char *fmt, ...) PRINTF_ATTRIBUTE(2, 3);;
extern size_t buffer_length(struct buffer *b);
