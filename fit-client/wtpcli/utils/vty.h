...
struct vty 
{
  ...
  enum {VTY_TERM, VTY_FILE, VTY_SHELL, VTY_SHELL_SERV, VTY_CONSOLE, VTY_HIDDEN} type;
...
#define TELNET_NAWS_SB_LEN 5
  ...
  /* Echo ON|OFF */
  enum {ECHO_ON=0, ECHO_OFF=1} echo;
...
extern struct vty *vty_console (const char * str, int first_node) ;
extern struct vty *vty_hidden (int fd);
...
extern void vty_alive(struct vty *vty);
